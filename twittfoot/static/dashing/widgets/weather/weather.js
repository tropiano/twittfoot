...
Dashing.widgets.Weather = function(dashboard) {
    ...
    this.getData = function () {
        ...
        $.get('https://query.yahooapis.com/v1/public/yql', {
            ...
            if (scope.query.results == null) {
                console.warn('Weather widget says: WOEID invalid');
                return;
            }
            var city = scope.query.results.channel.location.city,
                condition = scope.query.results.channel.item.condition;
            $.extend(self.scope, scope.query.results.channel);
        });
    };
